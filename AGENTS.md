...
This project is indexed by GitNexus as **suites** (2433 symbols, 5175 relationships, 207 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
