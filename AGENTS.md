...
This project is indexed by GitNexus as **suites** (2711 symbols, 5641 relationships, 231 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
