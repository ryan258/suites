...
This project is indexed by GitNexus as **suites** (888 symbols, 1857 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
