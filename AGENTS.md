...
This project is indexed by GitNexus as **suites** (2490 symbols, 5206 relationships, 212 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
