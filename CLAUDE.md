...
This project is indexed by GitNexus as **suites** (1835 symbols, 3999 relationships, 154 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
