...
This project is indexed by GitNexus as **suites** (2694 symbols, 5585 relationships, 230 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
