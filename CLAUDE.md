...
This project is indexed by GitNexus as **suites** (2320 symbols, 4950 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
