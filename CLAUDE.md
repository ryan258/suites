...
This project is indexed by GitNexus as **suites** (1242 symbols, 2653 relationships, 101 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
