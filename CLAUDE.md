...
This project is indexed by GitNexus as **suites** (2657 symbols, 5516 relationships, 226 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
