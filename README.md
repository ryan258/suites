...
VERIFIED CLAIMS: 1 Runtime Recovery (A2) | 10 Analysis Milestones (A1, A3-A5, O1-O6) | 0 Adopted | 0 Converged
PROTOTYPES: 32 checks passing; prototypes never count as recovered functionality
```
